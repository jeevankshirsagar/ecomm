...
const DashboardMenu = (props) => {
  ...
  const menuData = [
    ...
    {
      name: t("products"),
      icon: <BoxSeam width={18} height={18} />,
      target: "product",
      subMenu: [
        {
          name: t("all_products"),
    ...
    {
      name: t("orders"),
      icon: <BagCheck width={18} height={18} />,
      target: "order",
      subMenu: [
        {
          name: t("all_orders"),
    ...
    {
      name: t("categories"),
      icon: <UiChecksGrid width={18} height={18} />,
      target: "category",
      subMenu: [
        {
    ...
    {
      name: t("Coupons"),
      icon: <TagFill width={18} height={18} />,
      target: "coupon",
      subMenu: [
        {
          name: t("All Coupons"),
    ...
    {
      name: t("Attributes"),
      icon: <SettingsSuggest width={18} height={18} />,
      target: "attribute",
      subMenu: [
        {
    ...
    {
      name: t("Vendor"),
      icon: <ShopWindow width={18} height={18} />,
      target: "product",
      subMenu: [
        // {
        //   name: t("Vendor List"),
        ...
        // },
        // {
        //   name: t("Add New Vendor"),
        //   url: "/dashboard/vendor/create",
        //   create: true,
        // },
        // {
        //   name: t("Requests"),
    ...
    {
      name: t("Customers"),
      icon: <PeopleFill width={18} height={18} />,
      target: "customers",
      subMenu: [
        {
    ...
    {
      name: t("Manager"),
      icon: <PersonFill width={18} height={18} />,
      target: "no",
      subMenu: [
        {
          name: t("Staff List"),
