          ...
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>{t("Order")}</div>
          ...
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>{t("Customer")}</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
          ...
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>{t("Attribute")}</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>{t("Coupon")}</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div> 
