import { CardText, ChatLeftDots, StarHalf, Repeat, BagPlusFill } from "@styled-icons/bootstrap";
            ...
            <div className={classes.container}>
              ...
              <div>                                             
                ...
                <p>{t("compare")}</p>
                    ...
                    <div className={classes.cart_section}>
                      ...
                      <div className={classes.button_container}>
                        {stockInfo(data.product) ? (
                          ...
                          > 
                            {<BagPlusFill width={21} height={21}/>}
                    ...
                    <div className={classes.buy_section}>
                    <button onClick={gotoCheckout} className={classes.buy_button}>{t("BUY NOW")}</button>
                    </div>
                  </div>
                </div>
              </div>
